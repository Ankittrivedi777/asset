...
/**@brief Structure to hold nine axis values. 
...
/**@brief Function for reading nine axis data.
 *
 * @param[in]   nineaxis_values     Pointer to variable to hold nineaxis data
 * @retval      uint32_t        Error code
 */
uint32_t mpu_read_nineaxis(gyro_values_t * accel_values, gyro_values_t * gyro_values);
